...
public:
        NanoAODAnalyzerrdframe(std::string infilename, std::string intreename, std::string outfilename, std::string cat="", std::string year="", std::string jsonfname="", string globaltag="", int nthreads=1);
        NanoAODAnalyzerrdframe(TTree *t, std::string outfilename, std::string cat="", std::string year="", std::string jsonfname="", string globaltag="", int nthreads=1);
